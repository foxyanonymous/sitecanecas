...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            @endif
            <button class="btn btn-success mb-4" data-bs-toggle="modal" data-bs-target="#createModal">Criar Novo Usuário</button>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('usuarios.deletar', $user->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                    ...
                                    <div class="modal fade" id="editModal{{ $user->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $user->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('usuarios.atualizar', $user->id) }}" method="POST">
                                                        @csrf
